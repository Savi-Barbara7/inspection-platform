...
O projeto precisa de uma decisão explícita e estável para evidence integrity.

## Decision

Preserve originals, store hashes and derive thumbnails/annotations without destructively replacing originals.

## Rationale

Evidence requires provenance and auditability.
...
Deletion/retention behavior must be explicit and auditable.
