...
O projeto precisa de uma decisão explícita e estável para authentication strategy.

## Decision

Use Supabase Auth initially. Do not implement custom password/JWT stack.

## Rationale

Custom authentication creates unnecessary security risk.
...
MFA and enterprise SSO can be enabled later without redesigning the domain model.
